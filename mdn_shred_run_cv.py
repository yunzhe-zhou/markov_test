from markov_test.MDN_SHRED_CV import *
import argparse
...
string = "mdn_shred_run_cv" + "_T_" + str(args0.T) + "_test_lag_" + str(args0.test_lag)+ "_L_" + str(args0.L)+ "_B_" + str(args0.B) + "_M_" + str(args0.M) + "_Q_" + str(args0.Q) + "_lr_" + str(args0.lr) + "_num_h_" + str(args0.num_h) + "_n_iter_" + str(args0.n_iter)
...
class Setting:
    def __init__(self):
        ...
        self.B3=np.array([[0.25,-0.05,-0.05],[-0.05,0.25,-0.05],[-0.05,-0.05,0.25]])
        self.sim_type="shred"
        self.lr=args0.lr
        self.constant=0.1
        self.show=False
